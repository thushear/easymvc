...
public class HBaseHelper {
    ...
    public static HBaseHelper getDefaultHelper() throws IOException {
     ...
     * @return
     */
    public static HTable obtainHTable(String tableName){
        try {
            HBaseHelper helper = HBaseHelper.getDefaultHelper();
            HTable table = new HTable(HBaseHelper.configuration, tableName);
            return table;
        } catch (IOException e) {
            e.printStackTrace();
